...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_appContainer2.default, null), document.getElementsByClassName('content')[0]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _heroContainer = __webpack_require__(164);

	var _heroContainer2 = _interopRequireDefault(_heroContainer);

	var _infoContainer = __webpack_require__(165);

	var _infoContainer2 = _interopRequireDefault(_infoContainer);

	var _subscribeEmail = __webpack_require__(168);

	var _subscribeEmail2 = _interopRequireDefault(_subscribeEmail);
	    ...
	    _createClass(AppContainer, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_infoContainer2.default, { title: "HOW IT WORKS", id: "how-it-works" }),
	                _react2.default.createElement(_infoContainer2.default, { title: "WHY US", id: "why-ayooo" }),
	                _react2.default.createElement(_subscribeEmail2.default, null),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _navbarLinks = __webpack_require__(161);

	var _navbarLinks2 = _interopRequireDefault(_navbarLinks);

	var _burgerIcon = __webpack_require__(163);
	    ...
	    _createClass(Navbar, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: 'navbar' },
	                _react2.default.createElement('img', { className: 'navbar-logo', src: 'https://cloud.githubusercontent.com/assets/13470325/13969226/6819285a-f079-11e5-8d0b-ec337b6a2572.png' }),
	                _react2.default.createElement(_burgerIcon2.default, { toggle: this.toggleMenuVisibility, isMenuOpen: this.state.isMenuOpen }),
	                _react2.default.createElement(_navbarLinks2.default, { isDesktopView: this.state.isDesktopView, isMenuOpen: this.state.isMenuOpen })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NavbarLinks = function (_React$Component) {
	    _inherits(NavbarLinks, _React$Component);

	    function NavbarLinks() {
	        _classCallCheck(this, NavbarLinks);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(NavbarLinks).apply(this, arguments));
	    }
	    ...
	    _createClass(NavbarLinks, [{
	        ...
	        value: function render() {
	            ...
	            var classes = (0, _classnames2.default)("navbar-links-container", { "display-none": !this.props.isDesktopView && !this.props.isMenuOpen } // if mobileView and menu is open
	            );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BurgerIcon = function (_React$Component) {
	    ...
	    function BurgerIcon(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(BurgerIcon).call(this, props));
	    ...
	    _createClass(BurgerIcon, [{
	        ...
	        value: function render() {
	            ...
	            var classes = (0, _classnames2.default)("burger-menu-icon", { "menu-open": this.props.isMenuOpen });

	            return _react2.default.createElement(
	                'div',
	                { className: classes, onClick: this.props.toggle },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HeroContainer = function (_React$Component) {
	    _inherits(HeroContainer, _React$Component);

	    function HeroContainer() {
	        _classCallCheck(this, HeroContainer);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(HeroContainer).apply(this, arguments));
	    }

	    _createClass(HeroContainer, [{
	        key: 'render',
	        value: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _infoBlock = __webpack_require__(166);

	var _infoBlock2 = _interopRequireDefault(_infoBlock);

	var _infoBlockData = __webpack_require__(167);

	var _infoBlockData2 = _interopRequireDefault(_infoBlockData);
	...
	var InfoContainer = function (_React$Component) {
	    ...
	    function InfoContainer() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(InfoContainer).apply(this, arguments));
	    }
	    ...
	    _createClass(InfoContainer, [{
	        ...
	        value: function render() {
	            ...
	            var infoBlocks = _infoBlockData2.default[this.props.id].map(function (element, index, array) {

	                return _react2.default.createElement(_infoBlock2.default, { key: index, blockTitle: element.title, blockImage: element.image, blockText: element.text });
	            });
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'a',
	                    { className: 'anchor-tags', name: this.props.id },
	                    ' '
	                ),
	                _react2.default.createElement(
	                    'h3',
	                    { className: "info-container-title title-" + this.props.id },
	                    this.props.title
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: "info-block-container content-" + this.props.id },
	                    infoBlocks
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InfoBlock = function (_React$Component) {
	    ...
	    function InfoBlock() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(InfoBlock).apply(this, arguments));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _googleForm = __webpack_require__(169);
	...
	var SubscribeEmail = function (_React$Component) {
	    _inherits(SubscribeEmail, _React$Component);

	    function SubscribeEmail(props) {
	        _classCallCheck(this, SubscribeEmail);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(SubscribeEmail).call(this, props));
	    ...
	    _createClass(SubscribeEmail, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'h3',
	                    { className: 'info-container-title title-how-it-works' },
	                    'INTERESTED?'
	                ),
	                formArea
	            );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GoogleForm = function (_React$Component) {
	    _inherits(GoogleForm, _React$Component);

	    function GoogleForm() {
	        _classCallCheck(this, GoogleForm);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(GoogleForm).apply(this, arguments));
	    }

	    _createClass(GoogleForm, [{
	        key: 'render',
	        value: function render() {

	            return _react2.default.createElement(
	                'div',
	                { className: 'google-form-container display-none' },
	                _react2.default.createElement(
	                    'iframe',
	                    { className: 'google-form', src: 'https://docs.google.com/forms/d/19Ofbw4TWKGlvP7tZkQiS1dIb9M3B6nmbmA3Rz1-QJTA/viewform?embedded=true', frameBorder: '0', marginHeight: '0', marginWidth: '0' },
	                    'Loading...'
	                )
	            );
	        }
	    ...
	    _createClass(Form, [{
	        ...
	        value: function getInput(event) {
	            ...
	            this.checkInput(data, function (result) {
	                ...
	                result ? _this2.submit(data) : alert("Please complete all fields.");
	            });
	        }
	    }, {
	        key: 'submit',
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement('input', { className: 'form-radio', type: 'radio', name: 'useOfService', value: 'Shipper', ref: 'shipper' }),
	                        'Shipper'
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'form-query' },
	                        _react2.default.createElement('input', { className: 'form-radio', type: 'radio', name: 'useOfService', value: 'Traveller', ref: 'traveller' }),
	                        'Traveller'
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'form-query' },
	                        _react2.default.createElement('input', { className: 'form-radio', type: 'radio', name: 'useOfService', value: 'Both', ref: 'both' }),
	                        'Both!'
	                    )
	                ),
	                _react2.default.createElement(
